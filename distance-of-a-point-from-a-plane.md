...
* <mark style="color:purple;background-color:purple;">**If this plane passes through origin then we can use equation wTx = 0, that means w is perpendicular to the plane**</mark>
...
* <mark style="color:purple;background-color:purple;">**So for all the points above the plane, the distance between points and plane will be +ve**</mark>
* <mark style="color:purple;background-color:purple;">**And the distance below the plane, will be -ve**</mark>
